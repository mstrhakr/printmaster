...
type Store interface {
	...
	// Installer bundles
	CreateInstallerBundle(ctx context.Context, bundle *InstallerBundle) error
	GetInstallerBundle(ctx context.Context, id int64) (*InstallerBundle, error)
	FindInstallerBundle(ctx context.Context, tenantID, component, version, platform, arch, format, configHash string) (*InstallerBundle, error)
...
// InstallerBundle records tenant-specific installer outputs generated by the packager.
